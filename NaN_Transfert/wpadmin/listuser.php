		...
		<div class="container-fluid">
		  <div class="col-sm-12">
		    <div class="card card_member">
		      ...
		      <div class="card-body">
		        <h4 class="card-title">Nos Clients</h4>
		        	...
		        	<table class="table table-striped">
					  <thead>
					    <tr>
					      <th scope="col">#</th>
					      <th scope="col">Nom</th>
					      <th class="cacher" scope="col">Prénoms</th>
							  	...
							  	for ($i=0; $i < sizeof($resultats) ; $i++) { 
							  		...
							  		echo 	'
											    <tr>
											      ...
											      <td class="cacher">'.$resultats[$i]["prenom"].' fcfa</td>
											      <td class="cacher">'.$resultats[$i]["email"].'</td>
											      <td >'.$resultats[$i]["depot"].' fcfa</td>
											      <td >'.$resultats[$i]["username"].'</td>
											    </tr>
							  				';
							  	}
							  	echo "</tbody>";
